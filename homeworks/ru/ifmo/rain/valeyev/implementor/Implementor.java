...
/**
 * Class Implementor that implements Impler interface
 */
public class Implementor implements Impler {
     ...
     * @param token class which generated name should be returned
    ...
    /**
     * Return resolved parameters of executable
    ...
    /**
     * Return resolved exceptions of executable
    ...
    /**
     * Return resolved signature of executable
     * @param executable executable to resolve
     * @param token token of class executable belongs to
     * @param parameters[] types of parameters of executable
     ...
     * @param method method, which body must be resolved
    ...
    /**
     * Return body of method
     * @param executable executable, which body must be resolved
    ...
    /**
     * Class that encapsultes Method in it
     * <p>
     * True hashcode and equals methods
     */
    ...
    /**
     * Adds methods to set of TrueMethods
    ...
    /**
     * Returns resolved path of some generated stuff
     * @param token token of class
     * @param root path to class
     * @param suff String of suffix to add in the end
